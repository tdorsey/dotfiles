...
| 1.1 | Create `$HOME/.config/dotfiles/` directory | [ ] |
| 1.2 | Create `env.sh` - environment variables | [ ] |
| 1.3 | Create `login-once.sh` - login-only init | [ ] |
| 1.4 | Create `interactive.sh` - interactive setup | [ ] |
| 1.5 | Create `aliases.sh` - POSIX aliases | [ ] |
| 1.6 | Create `functions.sh` - bash/zsh functions | [ ] |
| 1.7 | Create `ssh_agent.sh` - SSH + tmux sync | [ ] |
| **Phase 2: Bridge Files** | | |
| 2.1 | Create `~/.profile` - POSIX login entry | [ ] |
| 2.2 | Create `~/.shrc` - POSIX sh bridge | [ ] |
| 2.3 | Create `~/.bashrc` - bash bridge | [ ] |
| 2.4 | Create `~/.zshrc` - zsh bridge | [ ] |
| **Phase 3: Tests** | | |
| 3.1 | Create `test/test_env.bats` | [ ] |
| 3.2 | Create `test/test_aliases.bats` | [ ] |
| 3.3 | Create `test/test_functions.bats` | [ ] |
| 3.4 | Create `test/test_ssh_agent.bats` | [ ] |
| **Phase 4: Verification** | | |
| 4.1 | Run all bats tests | [ ] |
| 4.2 | Verify shell startup works | [ ] |
| 4.3 | Verify XDG_CONFIG_HOME set correctly | [ ] |
| 4.4 | Verify SSH agent functions | [ ] |
| 4.5 | Verify tmux sync functions | [ ] |
